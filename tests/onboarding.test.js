...
assert.match(html, /Ce que vous pouvez faire/);
assert.match(html, /Rechercher rapidement des tickets/);
assert.match(html, /Filtrer et ouvrir plusieurs résultats/);
assert.match(html, /Retrouver facilement son activité Jira/);
